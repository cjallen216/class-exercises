...
-- 15. The name, population, and GNP of all countries with a GNP greater than $1 trillion dollars
-- and a population of less than 100 million people (4 rows)
...
-- 18. The name and average life expectancy of all countries on the continent of Oceania for which an average life expectancy has been provided
-- (i.e. not equal to null) (20 rows)
...
-- 19. The name of all countries on the continent of Oceania for which an average life expectancy has not been provided
-- (i.e. equal to null) (8 rows)
...
-- 20. The name, continent, GNP, and average life expectancy of all countries that have an average life expectancy of at least 70 years
-- and a GNP between $1 million and $100 million dollars (3 rows)
